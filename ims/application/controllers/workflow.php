...
if(!empty($CausticTankLevelData1)&& empty($CausticTankLevelTime1)&&empty($CausticTankLevelTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$CausticTankLevelTime1=date("h:i:sa");
                $CausticTankLevelTech1= $this->session->userdata('username');
...
if(!empty($CausticFlowData1)&& empty($CausticFlowTime1)&&empty($CausticFlowTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$CausticFlowTime1=date("h:i:sa");
                $CausticFlowTech1= $this->session->userdata('username');
...
if(empty($CausticFlowData1)&& !empty($CausticFlowTime1)&& !empty($CausticFlowTech1)){
  ...
  if(!empty($CausticStrengthData1)&& empty($CausticStrengthTime1)&&empty($CausticStrengthTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$CausticStrengthTime1=date("h:i:sa");
                $CausticStrengthTech1= $this->session->userdata('username');
...
if(!empty($AirDewpointData1)&& empty($AirDewpointTime1)&&empty($AirDewpointTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$AirDewpointTime1=date("h:i:sa");
                $AirDewpointTech1= $this->session->userdata('username');
...
if(empty($AirDewpointData1)&& !empty($AirDewpointTime1)&& !empty($AirDewpointTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		...
		$ValvesConnectedandSetTech1=$this->input->post('rear15'); 
                if(!empty($ValvesConnectedandSetData1)&& empty($ValvesConnectedandSetTime1)&&empty($ValvesConnectedandSetTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$ValvesConnectedandSetTime1=date("h:i:sa");
                $ValvesConnectedandSetTech1= $this->session->userdata('username');
  ...
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		...
		$AirPressureTech1=$this->input->post('rear18'); 
         ...
         if(!empty($AirPressureDATA1)&& empty($AirPressureTime1)&&empty($AirPressureTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$AirPressureTime1=date("h:i:sa");
               $AirPressureTech1= $this->session->userdata('username');
  ...
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		...
		$AirTemperAtureTech1=$this->input->post('rear21'); 
                    ...
                    if(!empty($AirTemperatureDATA1)&& empty($AirTemperAtureTime1)&&empty($AirTemperAtureTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$AirTemperAtureTime1=date("h:i:sa");
               $AirTemperAtureTech1= $this->session->userdata('username');
  ...
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
      ...
      if(!empty($VentingStArtedDATA1)&& empty($VentingStArtedTime1)&&empty($VentingStArtedTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$VentingStArtedTime1=date("h:i:sa");
              $VentingStArtedTech1= $this->session->userdata('username');
  ...
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
	...
	$ThiosulphateWashStArtedTech1=$this->input->post('rear27'); 	
           ...
           if(!empty($ThiosulphateWAshStartedDATA1)&& empty($ThiosulphateWAshStartedTime1)&&empty($ThiosulphateWashStArtedTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$ThiosulphateWAshStartedTime1=date("h:i:sa");
             $ThiosulphateWashStArtedTech1= $this->session->userdata('username');
...
$ThiosulphateWashCompletedTime1=$this->input->post('rear29'); 	
	...
	$ThiosulphateWashCompletedTech1=$this->input->post('rear30'); 
              if(!empty($ThiosulphateWashCompletedDATA1)&& empty($ThiosulphateWashCompletedTime1)&&empty($ThiosulphateWashCompletedTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$ThiosulphateWashCompletedTime1=date("h:i:sa");
           $ThiosulphateWashCompletedTech1= $this->session->userdata('username');
  ...
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		...
		$VesselCleanTech1=$this->input->post('rear33'); 	
         ...
         if(!empty($VesselCleanDATA1)&& empty($VesselCleanTime1)&&empty($VesselCleanTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$VesselCleanTime1=date("h:i:sa");
       $VesselCleanTech1= $this->session->userdata('username');
  ...
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
       ...
       $VesselCleanTech1= $this->session->userdata('username');
		...
		$VesselHydroTech1=$this->input->post('rear36'); 
                     if(!empty($VesselHydroDATA1)&& empty($VesselHydroTime1)&&empty($VesselHydroTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$VesselHydroTime1=date("h:i:sa");
      $VesselHydroTech1= $this->session->userdata('username');
  ...
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
      ...
      $VesselHydroTech1= $this->session->userdata('username');
		...
		$VesselDisassembled1=$this->input->post('rear39'); 
             ...
             if(!empty($VesselDisassembledDATA1)&& empty($VesselDisassembledTime1)&&empty($VesselDisassembled1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$VesselDisassembledTime1=date("h:i:sa");
     $VesselDisassembled1= $this->session->userdata('username');
  ...
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
     ...
     $VesselDisassembled1= $this->session->userdata('username');
		...
		$ConfinedSpacePermitTech1=$this->input->post('rear42');	
                       if(!empty($ConfinedSpacePermitDATA1)&& empty($ConfinedSpacePermitTime1)&&empty($ConfinedSpacePermitTech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
		$ConfinedSpacePermitTime1=date("h:i:sa");
    $ConfinedSpacePermitTech1= $this->session->userdata('username');
...
$VESSEL_READYFORINSPECTION_time=$this->input->post('rear43'); 
              if(!empty($VESSEL_READYFORINSPECTION_date1)&& empty($VESSEL_READYFORINSPECTION_time)&&empty($VESSEL_READYFORINSPECTION_tech1)){
  //  $d=mktime(11, 14, 54, 8, 12, 2014);
	$VESSEL_READYFORINSPECTION_time=date("h:i:sa");
   $VESSEL_READYFORINSPECTION_tech1= $this->session->userdata('username');
