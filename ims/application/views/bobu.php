...
<table width="200" border="1" style="position: absolute; left: 6%; top: 430px; width: 1391px; height: 172px;">
  ...
  <tr>
    <th scope="row">Actual-Initial</th>
     <td><input type="text" style="width:100%;height:100%;" value="<?php echo $row2->Actual_Initial_L?>" name="ac1" id="ac0" /></td>
  ...
  <tr>
    <th scope="row">Actual-Final</th>
       <td><input type="text" style="width:100%;height:100%;" value="<?php echo $row2->Actual_Final_L?>"name="af1" id="af0" /></td>
  ...
  <table width="792" height="865" border="1" style="position: absolute; left: 5%; top: 0%; font-weight: bold; width: 926px;">
    ...
    <tr>
      ...
      <td><div align="left">
       ...
       <td>
           <input id="demo14" readonly='readonly' value = "<?php echo $row6->CausticTankLevelTime?>"name="rear2" type="text" style="width:90%;"></td>
  
      <td>
          <input type="text"  style="width:97%;" readonly='radonly' value = "<?php echo $row6->CausticTankLevelTech?>"name="rear3" id="textfield28" /></td>
    </tr>
    <tr>
      <td>Caustic Flow</td>
      <td><div align="left">
      ...
      gpm</div></td>
     <td>
         <input id="demo13"value = "<?php echo $row6->CausticFlowTime?>"name="rear5" readonly='readonly' type="text" style="width:90%;"></td>
  
      <td>
          <input type="text" readonly='readonly' style="width:97%;"value = "<?php echo $row6->CausticFlowTech?>"name="rear6"  id="textfield29" /></td>
    </tr>
    <tr>
      ...
      <td><div align="left">
          ...
          %w/w      </div></td>
  <td>
      <input id="demo12" readonly='readonly'type="text" value = "<?php echo $row6->CausticStrengthTime ?>" name="rear8"  style="width:90%;"></td>
  
      <td>
          <input type="text"readonly='readonly' style="width:97%;"value = "<?php echo $row6->CausticStrengthTech?>"name="rear9"  id="textfield30" /></td>
    </tr>
    <tr>
      <td>Air Dewpoint</td>
      <td><div align="left">
      ...
      C</div></td>
      <td>
          <input id="demo11"readonly='readonly' type="text"value = "<?php echo $row6->AirDewpointTime?>" name="rear11" style="width:90%;"></td>
  
      <td>
          <input type="text"readonly='readonly' style="width:97%;"value = "<?php echo $row6->adptech?>"name="rear12"  id="textfield31" /></td>
    </tr>
    <tr>
      ...
      <td><div align="right">
       ...
       <td><input id="demo10"readonly='readonly' type="text"value = "<?php echo $row6->ValvesConnected_SetTime?>"name="rear14"  style="width:90%;"></td>
  
      <td><input type="text"readonly='readonly' style="width:97%;"value = "<?php echo $row6->ValvesConnected_SetTech?>"name="rear15"  id="textfield32" /></td>
    </tr>
    <tr>
      <td>Air Pressure</td>
      <td><div align="left">
        ...
        <td><input id="demo9"readonly='readonly' type="text"value = "<?php echo $row6->AirPressureTime?>"name="rear17"  style="width:90%;"> </td>
  
      <td><input type="text" readonly='readonly'style="width:97%;"value = "<?php echo $row6->AirPressureTech?>"name="rear18"  id="textfield33" /></td>
    </tr>
    <tr>
      ...
      F</div></td>
       <td><input id="demo8"readonly='readonly' type="text"value = "<?php echo $row6->AirTemperatureTime?>"name="rear20"  style="width:90%;"></td>
  
      <td><input type="text"readonly='readonly' style="width:97%;"value = "<?php echo $row6->AirTemperatureTech?>"name="rear21"  id="textfield34" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" style="width:97%;"value = "<?php echo $row6->ThiosulphateWashStartedData?>"name="rear25" id="textfield8" /></td>
       <td><input id="demo6" readonly='readonly'type="text"value = "<?php echo $row6->ThiosulphateWashStartedTime?>"name="rear26"  style="width:90%;"></td>
  
      <td><input type="text"readonly='readonly' style="width:97%;"value = "<?php echo $row6->ThiosulphateWashStartedTech?>"name="rear27"  id="textfield36" /></td>
    </tr>
    <tr>
      ...
      <td><input type="text" style="width:97%;"value = "<?php echo $row6->ThiosulphateWashCompletedData?>"name="rear28"  id="textfield9" /></td>
        <td><input id="demo5" readonly='readonly'value = "<?php echo $row6->ThiosulphateWashCompletedTime?>" name="rear29" type="text" style="width:90%;" </td>
  
      <td><input type="text" readonly='readonly'style="width:97%;"value = "<?php echo $row6->ThiosulphateWashCompletedTech?>"name="rear30"  id="textfield37" /></td>
    </tr>
    <tr>
      <td>Vessel Clean</td>
      <td><input type="text" style="width:97%;"value = "<?php echo $row6->VesselCleanData?>"name="rear31"  id="textfield11" /></td>
       <td><input id="demo4"readonly='readonly' type="text"value = "<?php echo $row6->VesselCleanTime?>"name="rear32"  style="width:90%;"></td>
  
      <td><input type="text"readonly='readonly' style="width:97%;"value = "<?php echo $row6->VesselCleanTech?>"name="rear33"  id="textfield38" /></td>
    </tr>
    <tr>
      ...
      psig</div></td>
        <td><input id="demo3"readonly='readonly' type="text"value = "<?php echo $row6->VesselHydroTime?>" name="rear35" style="width:90%;"></td>
  
      <td><input type="text"readonly='readonly' style="width:97%;"value = "<?php echo $row6->VesselHydroTech?>"name="rear36" id="textfield39" /></td>
    </tr>
    <tr>
      ...
      <td><input id="demo2"readonly='readonly' type="text"value = "<?php echo $row6->VesselDisassembledTime?>"name="rear38"  style="width:90%;"></td>
  
      <td><input type="text"readonly='readonly' style="width:97%;"value = "<?php echo $row6->VesselDisassembledTech?>"name="rear39"  id="textfield40" /></td>
    </tr>
    <tr>
    ...
    <td><input id="demo1"readonly='readonly' value = "<?php echo $row6->ConfinedSpacePermitTime?>"name="rear41"  type="text" style="width:90%;"></td>
  
    <td><input type="text"readonly='readonly' style="width:97%;"value = "<?php echo $row6->ConfinedSpacePermitTech?>"name="rear42"  id="textfield15" /></td>
    </tr></form>
    <tr>
    ...
    <td><input id="demo21" readonly='readonly'type="text"value = "<?php echo $row6->VESSELREADYFORINSPECTIONtime?>"name="rear43"  style="width:90%;"></td>
  
    <td><input type="text"readonly='readonly' style="width:97%;"value = "<?php echo $row6->VESSELREADYFORINSPECTIONtech?>"name="rear44"  id="textfield15" /></td>
    </tr>
    <tr>
